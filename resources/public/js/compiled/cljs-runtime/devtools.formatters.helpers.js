...
var G__41890 = devtools.prefs.pref(v);
v = G__41890;
continue;
} else {
return v;
...
}catch (e41789){var _e__40514__auto__ = e41789;
return false;
}})();
...
}catch (e41793){var _e__40514__auto__ = e41793;
return false;
}})();
...
}catch (e41804){var _e__40514__auto__ = e41804;
return false;
}}
}
});
...
var vec__41834 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41834,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41834,(1),null);
...
return cljs.core.some((function (p1__41859_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41859_SHARP_);
}),template);
});
