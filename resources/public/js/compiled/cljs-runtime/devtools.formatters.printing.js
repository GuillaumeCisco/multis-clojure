...
var len__4789__auto___41964 = arguments.length;
var i__4790__auto___41965 = (0);
while(true){
if((i__4790__auto___41965 < len__4789__auto___41964)){
args__4795__auto__.push((arguments[i__4790__auto___41965]));

var G__41966 = (i__4790__auto___41965 + (1));
i__4790__auto___41965 = G__41966;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41899){
var G__41900 = cljs.core.first(seq41899);
var seq41899__$1 = cljs.core.next(seq41899);
var G__41902 = cljs.core.first(seq41899__$1);
var seq41899__$2 = cljs.core.next(seq41899__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41900,G__41902,seq41899__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41926_SHARP_){
return (!((cljs.core.meta(p1__41926_SHARP_) == null)));
})))){
...
var map__41937 = opts;
var map__41937__$1 = (((((!((map__41937 == null))))?(((((map__41937.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41937.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41937):map__41937);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41937__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41941){var _e__40514__auto__ = e41941;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e41944){var _e__40514__auto__ = e41944;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41952 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41953 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41953);

try{var map__41954 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41954__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41952);
}});
...
var temp__5733__auto___42070 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42070)){
var managed_print_level_42071 = temp__5733__auto___42070;
var _STAR_print_level_STAR__orig_val__41957_42072 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41958_42073 = managed_print_level_42071;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41958_42073);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41956_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41956_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41957_42072);
}} else {
job_fn();
}
