...
if((typeof devtools !== 'undefined') && (typeof devtools.toolbox !== 'undefined') && (typeof devtools.toolbox.t_devtools$toolbox43684 !== 'undefined')){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox43684 = (function (obj,header,style,tag,meta43685){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
(devtools.toolbox.t_devtools$toolbox43684.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_43686,meta43685__$1){
var self__ = this;
var _43686__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox43684(self__.obj,self__.header,self__.style,self__.tag,meta43685__$1));
}));

(devtools.toolbox.t_devtools$toolbox43684.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_43686){
var self__ = this;
var _43686__$1 = this;
return self__.meta43685;
}));

(devtools.toolbox.t_devtools$toolbox43684.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL);

(devtools.toolbox.t_devtools$toolbox43684.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox43684.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
}));

(devtools.toolbox.t_devtools$toolbox43684.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox43684.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta43685","meta43685",-2104037766,null)], null);
}));

(devtools.toolbox.t_devtools$toolbox43684.cljs$lang$type = true);

(devtools.toolbox.t_devtools$toolbox43684.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox43684");

(devtools.toolbox.t_devtools$toolbox43684.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"devtools.toolbox/t_devtools$toolbox43684");
}));

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox43684.
 */
devtools.toolbox.__GT_t_devtools$toolbox43684 = (function devtools$toolbox$__GT_t_devtools$toolbox43684(obj__$1,header__$1,style__$1,tag__$1,meta43685){
return (new devtools.toolbox.t_devtools$toolbox43684(obj__$1,header__$1,style__$1,tag__$1,meta43685));
});

}

return (new devtools.toolbox.t_devtools$toolbox43684(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
}));
