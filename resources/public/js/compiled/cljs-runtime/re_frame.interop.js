...
return [(function (){var pred__52008 = cljs.core.instance_QMARK_;
var expr__52009 = reactive_val;
if(cljs.core.truth_((pred__52008.cljs$core$IFn$_invoke$arity$2 ? pred__52008.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__52009) : pred__52008.call(null,reagent.ratom.RAtom,expr__52009)))){
return "ra";
} else {
if(cljs.core.truth_((pred__52008.cljs$core$IFn$_invoke$arity$2 ? pred__52008.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__52009) : pred__52008.call(null,reagent.ratom.RCursor,expr__52009)))){
return "rc";
} else {
if(cljs.core.truth_((pred__52008.cljs$core$IFn$_invoke$arity$2 ? pred__52008.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__52009) : pred__52008.call(null,reagent.ratom.Reaction,expr__52009)))){
return "rx";
} else {
if(cljs.core.truth_((pred__52008.cljs$core$IFn$_invoke$arity$2 ? pred__52008.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__52009) : pred__52008.call(null,reagent.ratom.Track,expr__52009)))){
return "tr";
} else {
return "other";
}
