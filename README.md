...
* [`src/cljs/multis/`](src/cljs/multis/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/multis/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `multis` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/multis/config.cljs) defaults to `true` in
...
```clj
(ns multis.example
  (:require [multis.config :as config])
